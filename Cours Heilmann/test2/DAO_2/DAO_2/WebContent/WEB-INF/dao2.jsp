...
<p>
<c:forEach items="${resultatRecherche}" var="etudt">

<ul>

<li><c:out value="${etudt.identifiant}"></c:out></li>
<li><c:out value="${etudt.nom}"></c:out></li>
<li><c:out value="${etudt.prenom}"></c:out></li>
