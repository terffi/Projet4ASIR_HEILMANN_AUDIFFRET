...
public class MonCompte extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		compte = (Compte) maSession.getAttribute("compte"); //récupération du compte de la session
		
		//avant toute action, on vérifie que l'utilisateur est connecté avec un compte valide (présent dans la BDD)
			...
			if(action.equals("Modifier le compte")) {
				...
				if(compte!=null) {
					...
					if(valide) {
						...
						response.sendRedirect("/PolyBoardGames/mon_compte");
					}
					else {
